                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.reports.monthly_financials') }}" method="GET">
                            <div class="row align-items-end">
                                ...
                                <div class="col-md-3">
                                    <label class="text-bold-600">المنطقة</label>
                                ...
                                <div class="col-md-3">
                                    <button type="submit" class="btn btn-primary btn-block"><i class="ft-filter"></i> عرض التقرير</button>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-12">
                        <div class="card border-top-success border-top-3">
                            <div class="card-header"><h4 class="card-title text-success">تفاصيل التحصيلات</h4></div>
                            <div class="card-body">
                    ...
                    <div class="col-xl-6 col-lg-12">
                        <div class="card border-top-danger border-top-3">
                            <div class="card-header"><h4 class="card-title text-danger">مصروفات المناطق</h4></div>
                            <div class="card-body">
                                <table class="table table-hover table-bordered">
