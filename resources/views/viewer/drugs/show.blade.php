                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('viewer.drugs.index') }}">الأدوية</a></li>
            ...
            <div class="content-body">
                ...
                <div class="card filter-card box-shadow-1 border-top-info border-top-3 mb-2 no-print">
                    <div class="card-body py-2">
                        <form action="{{ route('viewer.drugs.show', $drug->id) }}" method="GET" id="searchForm">
                            <div class="row align-items-end">
                                ...
                                <div class="col-md-3 mb-1 d-flex">
                                    ...
                                    <a href="{{ route('viewer.drugs.show', $drug->id) }}" class="btn btn-outline-secondary" title="إلغاء الفلتر"><i class="ft-x"></i></a>
                                </div>
                            </div>
                        </form>
                    </div>
                                        ...
                                        <table class="table table-hover mb-0">
                                            ...
                                            @forelse($salesHistory as $detail)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('viewer.invoices.show', $detail->invoice_id) }}" target="_blank" class="btn btn-sm btn-outline-info">
                                                            <i class="ft-eye"></i>
                                                        </a>
                                                    </td>
                                                </tr>
