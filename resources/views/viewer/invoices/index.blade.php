            ...
            <div class="content-body">
                ...
                <div class="card filter-card box-shadow-1 no-print">
                    <div class="card-content collapse show">
                        <div class="card-body">
                            <form action="{{ route('viewer.invoices.index') }}" method="GET" id="searchForm">
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="gap-1 mb-1 col-md-6 d-flex align-items-end">
                                        ...
                                        <a href="{{ route('viewer.invoices.index') }}" class="btn btn-outline-secondary" title="إلغاء الفلاتر">
                                            <i class="ft-x"></i>
                                        </a>
                                    </div>
                                </div>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group" role="group">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item" href="{{ route('viewer.invoices.show', $invoice->id) }}">
                                                                    <i class="mr-1 ft-eye text-info"></i> تفاصيل الفاتورة
                                                                </a>
                                                                <div class="dropdown-divider"></div>
                                                                <a class="dropdown-item" href="{{ route('viewer.invoices.pdf', $invoice->id) }}" target="_blank">
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="7" class="py-3 text-center text-muted">
                                                        ...
                                                        <br>
                                                        <a href="{{ route('viewer.invoices.create') }}" class="mt-1 btn btn-sm btn-primary">إضافة فاتورة جديدة</a>
                                                    </td>
                                                </tr>
                                            @endforelse
